...
def get_parser():
    ...
    # Validation
    parser.add_argument("--validation_content_dir", type=str)
    parser.add_argument("--validation_style_dir", type=str)
    parser.add_argument("--validation_gt_dir", type=str)
    parser.add_argument("--validation_tmp_dir", type=str, default="tmp_gen")
    parser.add_argument("--validation_num_samples", type=int, default=1200)
    # Augmentation
    parser.add_argument("--augment_content", action="store_true",
                        help="Whether to use the content augmentation.")
    parser.add_argument("--augment_content_prob", type=float, default=0.5,
                        help="The probability of using the content augmentation.")
    parser.add_argument("--augment_style", action="store_true",
                        help="Whether to use the style augmentation.")
    parser.add_argument("--augment_style_prob", type=float, default=0.5,
                        help="The probability of using the style augmentation.")
    ## SCR
